...
class Exercise1 {
    ...
    void calcTotalYearsSpentInEpam() {
        ...
        Long hours = employees.stream()
                              ...
                              .filter(jobEntry -> jobEntry.getEmployer().equalsIgnoreCase("EPAM"))
    ...
    void findPersonsWithQaExperience() {
        ...
        Set<Person> workedAsQa = employees.stream()
                                          .filter(employee -> employee.getJobHistory()
                                                                      .stream()
                                                                      .anyMatch(jobEntry -> jobEntry.getPosition()
                                                                                                    .equalsIgnoreCase("QA")))
    ...
    void groupPersonsByFirstPositionUsingToMap() {
        ...
        Map<String, Set<Person>> result = employees.stream()
                                                   .collect(Collectors.toMap(employee -> employee.getJobHistory()
                                                                                                 .get(0)
                                                                                                 .getPosition(),
